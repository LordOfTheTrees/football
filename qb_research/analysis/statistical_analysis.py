"""
Statistical analysis functions for QB research.

This module contains functions for:
- Correlation analysis between QB stats and team wins
- Principal Component Analysis (PCA) of QB statistics
- Regression analysis using PC1 factors
"""
